sap.ui.define([
    ...
    function (Extension) {
        "use strict";
        var CardExtension = Extension.extend("winnings.outbound_delivery_list_ic.ext.FormatterExtension");
        ...
        CardExtension.prototype.getData = function (arg) {
            ...
            if (!sFilterString) {
                ...
                return oCard.request({
                    "url" : "{{destinations.ds4}}/sap/opu/odata/sap/API_OUTBOUND_DELIVERY_SRV;v=2/A_OutbDeliveryHeader?$filter=" + sFilterString + "&$format=json",
